<div class="footer" style="display: block">
    ...
    <ul class="footer-socials">
        <li class="btn-sm btn-sm-big"><a target='_blank' href="https://web.facebook.com/presidencebenin" class="fab fa-facebook" title="Facebook"></a></li>
        <li class="btn-sm btn-sm-big"><a target='_blank' href="https://twitter.com/PresidenceBenin" class="fab fa-twitter" title="Twitter"></a></li>
        <li class="btn-sm btn-sm-big"><a target='_blank' href="https://youtube.com/PresidenceBenin" class="fab fa-youtube" title="Youtube"></a></li>
        <li class="btn-sm btn-sm-big"><a target='_blank' href="https://www.flickr.com/presidencebenin/albums/" class="fab fa-flickr" title="Flickr"></a></li>
        <li class="btn-sm btn-sm-big"><a target='_blank' href="https://soundcloud.com/presidencebenin/" class="fab fa-soundcloud" title="Soundcloud"></a></li>
    </ul>
    <ul class="footer-nav">
        <li>
        ...
        <li>
            ...
            <ul>
                <li><a target="_blank" href="#https://revealingbenin.com/">Bénin Révélé</a></li>
                <li><a target="_blank" href="#https://sgg.gouv.bj/">Secrétariat Général du Gouvernement</a></li>
                <li><a target="_blank" href="#https://competences.presidence.bj/">Compétences au service du Bénin</a></li>
                <li><a target="_blank" href="#evaluation-politiques-publiques.html">Évaluation des politiques publiques</a></li>
            </ul>
        </li>
    </ul>
    ...
    <span class="center">&copy; 2019 Présidence de la République du Bénin - presidence.bj</span>
...
<script src="<?= $assetsUrl ?>public/js/custom.js?v=1.12"></script>
</body>
