                ...
                <div class="col-md-3 col-sm-6">
                    <div class="news-box">
                        ...
                        <div class="new-txt">
                            ...
                            <h6><a href="<?= site_url('events/seminaire-sur-la-bonne-gestion-des-processus-evaluation') ?>" data-toggle="tooltip" title="Stratégies de croissances pour la réduction de la pauvreté" >Stratégies de croissances pour la réduction de la pauvreté</a></h6>
                ...
                <div class="col-md-3  col-sm-6">
                    <div class="news-box">
                        ...
                        <div class="new-txt">
                            ...
                            <h6><a href="<?= site_url('events/seminaire-sur-la-bonne-gestion-des-processus-evaluation') ?>" data-toggle="tooltip" title="Politique Nationale de Développement de l’Artisanat (PNDA)" >Politique Nationale de Développement de l’Artisanat (PNDA)</a></h6>
                ...
                <div class="col-md-3  col-sm-6">
                    <div class="news-box">
                        ...
                        <div class="new-txt">
                            ...
                            <h6><a href="<?= site_url('events/seminaire-sur-la-bonne-gestion-des-processus-evaluation') ?>" data-toggle="tooltip" title="Politique Nationale du Tourisme" >Politique Nationale du Tourisme</a></h6>
                ...
                <div class="col-md-3  col-sm-6">
                    <div class="news-box">
                        ...
                        <div class="new-txt">
                            ...
                            <h6><a href="<?= site_url('events/seminaire-sur-la-bonne-gestion-des-processus-evaluation') ?>" data-toggle="tooltip" title="Insécurité alimentaire : un regard sur les réponses apportées par les diverses parties prenantes" >Insécurité alimentaire : un regard sur les réponses apportées par les diverses parties prenantes</a></h6>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="event-post">
                        ...
                        <div class="event-post-txt">
                            <h5><a  href="<?= site_url('events/seminaire-sur-la-bonne-gestion-des-processus-evaluation') ?>" data-toggle="tooltip" title="Séminaire sur la bonne gestion des processus d'évaluation">Séminaire sur la bonne gestion des processus d'évaluation </a></h5>
                            <ul class="event-meta">
                                <li><i class="far fa-calendar-alt"></i> 3-6 Novembre, 2019</li>
                                <li><i class="far fa-clock"></i> 09H - 13H</li>
                            </ul>
                            <p >Séminaire portant sur la bonne gestion des processus évaluatifs concernant les acteurs de l'UNICEF et de la présidence</p>
                        </div>
