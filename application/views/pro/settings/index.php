                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            get_form_upload($data, $extensions = 'jpg jpeg png ico', '2M', true, 'auto-upload ignore');
                            echo get_form_error($fieldName);
                            getFieldInfo('Dimensions recommandées : 150x150 Format : JPG|PNG|JPEG|ICO Taille Max : 2M');
                            ?>
                        </div>
                        <div class="form-group">
                            ...
                            get_form_upload($data, $extensions = 'jpg jpeg png', '2M', true, 'auto-upload ignore');
                            echo get_form_error($fieldName);
                            getFieldInfo('Dimensions recommandées : 150x150 Format : JPG|PNG|JPEG Taille Max : 2M');
                            ?>
                        </div>
